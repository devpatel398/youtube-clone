...
import { VideoGridCard, VideoGridCardSkeleton } from "@/modules/videos/ui/componenets/video-grid-card";
...
const HomeVideosSectionSkeleton = () => {
    return (
        <div>
            <div className="gap-4 gap-y-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 [@media(min-width:1920px)]:grid-cols-4 
